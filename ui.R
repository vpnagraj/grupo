...
shinyUI(navbarPage("GRUPO", header=(tags$h1("GRUPO", align='center', tags$br(tags$em(tags$small("Gauging Research University Publication Output", align='center'))))), footer=tags$div(style='margin:20px;',tags$a(href = "https://www.gnu.org/licenses/gpl.txt", "AVAILABLE UNDER GNU GPL 3.0 LICENSE"), tags$p(icon("copyright"), "2015 VP Nagraj")),
        tabPanel("Home",
        sidebarPanel(
